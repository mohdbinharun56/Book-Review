                ...
                <div>
                    ...
                    <div className="flex gap-5 mt-3">
                        <p className='flex gap-10'>
                            ...
                            <span className="flex gap-5">{tags.map((tag, index) => <span key={index} className='text-[#23BE0A] font-medium text-sm'>{tag}</span>)}</span>
                        </p>
                    ...
                    <div className="mt-5 grid grid-cols-2 lg:grid-cols-3 gap-4 text-center">
                        ...
                        <p className="text-[#554612] bg-[#d7bb91] rounded-full p-3 font-sans text-sm lg:text-base">Rating: {rating}</p>
